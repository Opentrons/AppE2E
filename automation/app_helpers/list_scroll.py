...
def scroll_until_visible(
    ...
    *,
    ...
    Raises ``RuntimeError`` if the target is still missing after scrolling.
    """
    ...
    raise RuntimeError(not_found_message or "Target element not found after scrolling the list.")
