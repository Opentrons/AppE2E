...
class LabwarePage(AppBasePage):
    ...
    # Electron serves the SPA from file://…/index.html with hash routing (#/labware).
    LABWARE_LANDING_URL = re.compile(r"#/labware/?$")
    ...
    def navigate(self) -> None:
        ...
        navigate_to(self.page, "Labware", self.LABWARE_LANDING_URL)
